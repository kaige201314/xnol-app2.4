...
class BaseAction(object):
    ...
    def by_names(self, the_name):
        return self.driver.find_elements_by_name(the_name)
    
    def by_class_names(self,the_class_names):
        return self.driver.find_elements_by_class_name(the_class_names)
    ...
    #封装页面滑动方法，须传入参数：方向direction(left\right\up\down)和滑动时间t,单位ms
